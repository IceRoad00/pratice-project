...
import com.estate.back.service.implementation.Oauth2UserServiceImplementaion;
...
// - JwtAuthenticationFilter 추가 (UsernamePasswordAuthenticationFliter 이전에 추가)
...
public class WebSecurityConfig {
    ...
    private final Oauth2UserServiceImplementaion oAuth2UserService;
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
            ...
            // 특정한 요청들에 대해서 어떠한 조치를 취해야하는지 정해줌
