...
public class EstateEntity {
    ...
    private Double return40;            // 40m2 이하 수익율
    private Double return4060;          // 40m2 초과 60m2 이하 수익율
    private Double return6085;          // 60m2 초과 85m2 이하 수익율
    private Double return85;            // 85m2 초과 수익율
