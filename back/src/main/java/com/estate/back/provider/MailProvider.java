...
// - 인터넷을 통해서 이메일 메세지를 보내고 받는데 사용되는 통신 프로토콜
// - 메일 서버 및 기타 메세지 전송 에이전트(MTA)에서 메일 전송, 수신, 중계를 할 때 사용
// - 기본 포트 : TCP 25
...
public class MailProvider {
    ...
    public void mailAuthSend(String to, String authNumber) throws MessagingException {
        ...
        // 메세지 내용 지정
        mimeMessage.setText(authNumber, "utf-8", "html");
        // 메세지 전송
